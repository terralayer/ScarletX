...
Container releases always use matching versions for both images, for example ScarletX 0.3.10-beta.4:

```text
ghcr.io/terralayer/scarletx:0.3.10-beta.4
ghcr.io/terralayer/scarletx-web:0.3.10-beta.4
```
...
Current application version: **0.3.10-beta.4**.

See `RELEASE-NOTES-0.3.10-beta.4.md` for the current release summary.
