...
Container releases always use matching versions for both images, for example ScarletX 0.4.4:

```text
ghcr.io/terralayer/scarletx:0.4.4
ghcr.io/terralayer/scarletx-web:0.4.4
```
...
Current application version: **0.4.4**.

See `RELEASE-NOTES-0.4.4.md` for the current release summary.
