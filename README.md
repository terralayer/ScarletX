...
Container releases always use matching versions for both images, for example ScarletX 0.4.0:

```text
ghcr.io/terralayer/scarletx:0.4.0
ghcr.io/terralayer/scarletx-web:0.4.0
```
...
See `RELEASE-NOTES-0.4.0.md` for the current release summary.
