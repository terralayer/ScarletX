...
Container releases always use matching versions for both images, for example ScarletX 0.4.5:

```text
ghcr.io/terralayer/scarletx:0.4.5
ghcr.io/terralayer/scarletx-web:0.4.5
```
...
Current application version: **0.4.5**.

See `RELEASE-NOTES-0.4.5.md` for the current release summary.
