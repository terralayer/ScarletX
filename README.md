...
Container releases always use matching versions for both images, for example ScarletX 0.3.10:

```text
ghcr.io/terralayer/scarletx:0.3.10
ghcr.io/terralayer/scarletx-web:0.3.10
```
...
See `RELEASE-NOTES-0.3.10.md` for the current release summary.
