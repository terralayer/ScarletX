...
Container releases always use matching versions for both images, for example ScarletX 0.3.10-beta.2:

```text
ghcr.io/terralayer/scarletx:0.3.10-beta.2
ghcr.io/terralayer/scarletx-web:0.3.10-beta.2
```
...
Current application version: **0.3.10-beta.2**.

See `RELEASE-NOTES-0.3.10-beta.2.md` for the current release summary.
