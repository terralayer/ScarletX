...
- The active release target remains locked to `0.5.0`. Feature work and all shipped metadata must retain `0.5.0` until a new dedicated release change is authorized.
