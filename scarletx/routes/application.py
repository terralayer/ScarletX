...
async def lifespan(_: FastAPI):
    ...
    with SessionLocal() as db:
        ...
        try:
            print(render_dashboard(collect_startup_status(db, runtime), version="0.4.3"), flush=True)
...
app = FastAPI(title="ScarletX API", version="0.4.3", lifespan=lifespan, default_response_class=ORJSONResponse)
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "ScarletX", "version": "0.4.3", "upstream": "SceneCore 0.7.16"}
