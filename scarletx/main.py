...
app = FastAPI(title="ScarletX API", version="0.3.6", lifespan=lifespan, default_response_class=ORJSONResponse)
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "ScarletX", "version": "0.3.6", "upstream": "SceneCore 0.7.16"}
